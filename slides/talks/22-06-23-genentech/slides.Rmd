...
.center.faces[
.fl.w-20.f6[<strong class="gene-color">J. Duncan</strong>]
.fl.w-20.f6[<strong class="gene-color">T. Tang</strong>]
.fl.w-20.f6[C.F. Elliott]
.fl.w-20.f6[<strong class="gene-color">P. Boileau</strong>]
.fl.w-20.f6[<strong class="gene-color">B. Yu</strong>]
]

80% <strong class="gene-color">Genentech</strong> alumni!
...
--
```{r}
sparse_dgp_fun <- function(n=100, d=100, rho=0.5, sparsity=0.5, noise_level=1,
...
experiment <- create_experiment(
  ...
  dgp_list = list("dense" = dense_dgp,
                  "sparse" = sparse_dgp),
  method_list = list("ols" = ols_method,
                     "elnet" = elnet_method)) %>%
  add_vary_across(
    .dgp = "sparse",
    n = c(100, 500, 1000),
